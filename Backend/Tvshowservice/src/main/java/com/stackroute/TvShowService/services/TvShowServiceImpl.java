...
public class TvShowServiceImpl implements TvShowService{
    ...
    public TvShow addTvShow(TvShow tvShow, MultipartFile file) throws TvShowAlreadyExistsException {
        ...
        if (file != null && !file.isEmpty()) {
            try {
                String filePath = "C:\\FinalProject\\static-server\\images\\" + savedTvShow.getTvShowId() + ".jpg";
    ...
    private void updateTvShowImage(TvShow tvShow, MultipartFile file) {
        if (file != null && !file.isEmpty()) {
            try {
                String filePath = "C:\\FinalProject\\static-server\\images\\" + tvShow.getTvShowId() + ".jpg";
                file.transferTo(new File(filePath));
